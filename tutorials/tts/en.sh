...
train_manifest=${dataset}/manifest_train.json
test_manifest=${dataset}/manifest_test.json
...
if [ ${stage} -eq 6 ]; then
    ...
    for manifest in ${train_manifest} ${test_manifest}; do
        ...
        #     --mels_dir ${mels_dir} \
        #     --specgen_ckpt_dir ${specgen_ckpt_dir} \
        #     --hifigan_manifest_path ${dataset}/$(basename ${manifest%.*})_hifigan.json
    done
fi
...
if [ ${stage} -eq 7 ]; then
    ...
    # val="/home/syl20/data/en/6097_5_mins/6097_manifest_dev_ns_all_local_hifigan.json"
    # train="/home/syl20/data/en/6097_5_mins/6097_manifest_train_dur_5_mins_local_hifigan.json"
    pretrained_checkpoint="tts_hifigan" # pre-trained nvidia model
    exp="test_finetune_hifigan"
