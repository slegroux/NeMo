...
if [ ${stage} -eq 100 ]; then
    /home/syl20/maui/scripts/datasets/train_test_split_file.py --train_size 0.99 ${manifest_filepath}
fi
...
if [ ${stage} -eq 9 ]; then
    ...
    # 6097
    # specgen_ckpt_dir="ljspeech_to_6097_no_mixing_5_mins"
    # vocoder_ckpt_dir="test_finetune_hifigan"
    # KAREEM
    specgen_ckpt_dir=kareem
    vocoder_ckpt_dir=kareem
    speed_factor=0.8
    pitch_factor=2.0
    pitch_scale=2.0
    python fastpitch_synth.py \
        ...
        --input_text "This is a test of how well this new model is behaving." \
        --output_audio "this_is_a_test-kareem-hifigan-sp${speed_factor}-pf${pitch_factor}-ps${pitch_scale}.wav" \
        --sr 22050
fi
